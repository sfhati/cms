...
<script type="text/javascript" src="jscripts/for_fckeditor.js"></script>
<script type="text/javascript">
	...
	var urls = {
			...
			'present':'<?php echo addslashes(getCurrentUrl()); ?>',
...
<body>
	<div id="wrapper">
  	<div id="header">
            <a href="<?php echo $_SESSION['SITE_LINK']; ?>plugin/filemanager/ajaxfilemanager.php?path=<?php echo $_SESSION['filemanagertemplates']; ?>"><span class="folderEmpty">&nbsp;</span>Templates </a>
            <a href="<?php echo $_SESSION['SITE_LINK']; ?>plugin/filemanager/ajaxfilemanager.php?path=<?php echo $_SESSION['filemanagersfhati']; ?>"><span class="folderEmpty">&nbsp;</span>Sfhati </a>
            <a href="<?php echo $_SESSION['SITE_LINK']; ?>plugin/filemanager/ajaxfilemanager.php?path=<?php echo $_SESSION['filemanageruploaded']; ?>"><span class="folderEmpty">&nbsp;</span>Uploaded </a>
    ...
    <div id="body">
      ...
      <div id="rightCol">
			...
			if(CONFIG_LOAD_DOC_LATTER )
			{
				...
				?>
				<script type="text/javascript">
				parentFolder = {path:'<?php echo addslashes(getParentFolderPath($currentPath)); ?>'}; 
